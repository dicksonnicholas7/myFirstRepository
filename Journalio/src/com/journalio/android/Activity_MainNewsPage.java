...
public class Activity_MainNewsPage extends Activity {
	 ...
	 * 
	 * 
	 * 1. This is the profile Activity. It basically displays the profile page when called from either the my post activity or the my profile activity
	 ...
	 * 4. The variables declared in step 2 are all initialised with the appropriate objects. tab_0 = (TextView )findViewById(R.id.nav_tv_0); tab_1 = (TextView)findViewById(R.id.nav_tv_1);
	 * 5. tab_0.setOnTouchListener 0 This line of code listens to touch events on the Trending Tab and displays/runs the trending activity once the Tab is selected and active.
